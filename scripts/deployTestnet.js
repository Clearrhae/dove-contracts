...
async function main() {
    ...
    const firstEpochTimestamp = (await provider.getBlock()).timestamp + 30 * 60; // 30 minutes from now
    ...
    console.log(
        ...
        await (await treasury.toggle('8', stakingDistributor.address, zeroAddress)).wait();
